              ...
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="nombre"
                    placeholder="Nombre. Ejemplo (Pepito Pérez)"
                    required=""
                    v-model="datoUsuario.name"
                  />
                </div>
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="email"
                    placeholder="Correo electrónico. Ejemplo (peperez@gmail.com)"
                    required=""
                    v-model="datoUsuario.email"
                  />
                </div>
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="clave"
                    placeholder="Clave mínimo de 8 dígitos."
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    id="clave"
                    placeholder="Clave mínimo de 8 dígitos."
                    v-model="datoUsuario.password_confirmation"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header bg-info">
              <h5 class="modal-title">
                <i class="fas fa-info-circle"></i> Detalles del usuario
              </h5>
              <button
                type="button"
                class="close"
...
export default {
  ...
  methods: {
    ...
    crear() {
      axios
        .post("crear_usuarios", this.datoUsuario)
        .then((res) => {
          this.getUser();
    ...
    editar() {
      axios
        .put("editar_usuarios/" + this.idUser, this.datoUsuario)
        .then((res) => {
          this.idUser = "";
          this.getUser();
          $("#modalForm").modal("hide");
    ...
    eliminar(datos) {
      swal({
        ...
        if (willDelete) {
          axios
            .delete("eliminar_usuarios/" + datos.id)
            .then((res) => {
              this.getUser();
